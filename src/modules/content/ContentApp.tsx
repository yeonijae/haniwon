...
type ViewMode = 'blog' | 'guide' | 'landing' | 'event_dm' | 'youtube';
  ...
  return (
    <div className="h-screen bg-gray-100 flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-hidden overflow-y-auto">
        {viewMode === 'blog' && <BlogManagement />}
        {viewMode === 'youtube' && <YouTubeManagement />}
        {viewMode === 'guide' && <GuideManagement />}
        {viewMode === 'landing' && <LandingManagement />}
        {viewMode === 'event_dm' && <EventDMManagement />}
      </div>
    </div>
  );
};
